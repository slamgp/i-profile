...
<div class="layout">
    ...
    <div class=maincontent id="mainContext">
        <table class="registrationTable" id="registrationTable">
            <tr>
                <td>login:</td>
                <td><input id="reg_login" type="text" value=""></td>
            </tr>
            <tr>
                <td>email:</td>
                <td><input id="reg_email" type="text" value=""></td>
            </tr>
            <tr>
                <td>password:</td>
                <td><input id="reg_password" type="password" value=""></td>
            </tr>
            <tr>
                <td class="buttonTd" colspan="2">
                    <button class="sentButton" id="btnSentRegistartion">sent</button>
                </td>
            </tr>
        </table>
        ...
        <table class="registrationTable" id="authenticationTable">
            <tr>
                <td>email:</td>
                <td><input id="outh_email" type="text" value=""></td>
            </tr>
            <tr>
                <td>password:</td>
                <td><input id="outh_password" type="password" value=""></td>
            </tr>
            <tr>
                <td class="buttonTd" colspan="2">
                    <button class="sentButton" id="btnSentAutontification">sent</button>
                </td>
            </tr>
        </table>
    </div>
